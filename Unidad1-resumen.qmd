...
Las estructuras de datos que se utilizan en R están diseñadas con el fin de facilitar la manipulación de los datos, las estructuras más utilizadas son: vectores, factores, listas, matrices y marco de datos.
...
Esta estructura no permite agregar todos los datos m\[edicos de un paciente en un objeto que se utilice de manera repetida
